    ...
    public Dimas07146_GUI(){
        ...
        add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    View.Dimas07146_AddGUI addGUI = new Dimas07146_AddGUI();
                    mv.dispose();
        ...
        view.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    View.Dimas07146_ViewGUI viewGUI = new Dimas07146_ViewGUI();
                    mv.dispose();
                }catch (Exception exception){
                    JOptionPane.showMessageDialog(null,"Salah Data!","information",JOptionPane.INFORMATION_MESSAGE);
                }
        ...
        delete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    View.Dimas07146_DeleteGUI deleteGUI = new Dimas07146_DeleteGUI();
                    mv.dispose();
                }catch (Exception exception){
                    JOptionPane.showMessageDialog(null,"Salah Data","information",JOptionPane.INFORMATION_MESSAGE);
                }
